...
export default {
  ...
  data () {
    return {
      ...
      deviceCollection: [
        {name: 'RED', isOn: false, image: require('./assets/light.png')},
        {name: 'GREEN', isOn: true, image: require('./assets/light.png')},
        {name: 'BLUE', isOn: true, image: require('./assets/light.png')}
      ]
    }
  },
  methods: {
